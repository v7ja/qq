...
$settings = (new \danog\MadelineProto\Settings\AppInfo) ->setApiId(24726477) ->setApiHash('ba993a0f5b0bccfbf2a25d061826eeed');
...
$tg->vtcor('sendmessage',['chat_id'=>$chat_id, 'text'=>"• حسناً . الان ارسل كود التحقق المكون من ٥ ارقام مثال : 63796"]);
...
$tg->vtcor('sendmessage',['chat_id'=>$chat_id, 'text'=>"• حسناً . الان ارسل كلمة السر مثال : Pyroo"]);
